...
'value'=>function($model,$key,$index,$column)
{
    ...
    'panel' => [
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i> List of divisions' . '</h3>',
            'type' => 'success',
           // 'before' => Html::a('<i class="glyphicon glyphicon-plus"></i> Create division', ['create'], ['class' => 'btn btn-success']).'<h3>'.''.'</h3>',
            'after' => Html::a('<i class="glyphicon glyphicon-repeat"></i> Reset Grid', ['/Division'], ['class' => 'btn btn-info']),
            'footer' => false
        ],
    ]); ?>
