...
<div class="reply-form">
    ...
    <?php $form = ActiveForm::begin(['action'=>\yii\helpers\Url::to(['/reply/create?ct='.$model->content_type.'&ctid='.$model->content_type_id])]); ?>
	<?php 
    ...
    <?= 
		$form->field($model, 'attachments')->widget(\app\widgets\FileWidget::classname()) 
		?>
